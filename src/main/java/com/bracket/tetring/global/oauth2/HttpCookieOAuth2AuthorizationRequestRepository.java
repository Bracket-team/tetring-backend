package com.bracket.tetring.global.oauth2;
...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    @Override
    public void saveAuthorizationRequest(OAuth2AuthorizationRequest authorizaionRequest, HttpServletRequest request, HttpServletResponse response) {
        if (authorizaionRequest == null) {
        ...
        CookieUtils.addCookie(response,
                ...
                CookieUtils.serialize(authorizaionRequest),
